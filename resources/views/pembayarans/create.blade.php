    ...
    <div class="container-fluid">
                    ...
                    <div class="card-body">
                        <form action="{{ route('pembayarans.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                <strong>Siswa</strong>
                                <select name="nisn" id="nisn" class="form-control" id="nisn"
                                    onchange="getData()">
                                    <option value="" selected disabled>Pilih Siswa</option>
                                    @foreach ($siswa as $a)
                                        <option value="{{ $a->nisn }}">Nisn : {{ $a->nisn }} | Nama :
                                            {{ $a->nama }} | Spp - Rp. {{ number_format($a->nominal) }}</option>
                                    @endforeach
                                </select>
                                <br><br>
                                <div class="form-group">
        ...
        <script>
            $('#nisn').on('change', function() {
                ...
                $.ajax({
                    url: "{{ url('/pembayarans/get-data/') }}" + "/" + nisn + "/" + berapa,
                    type: "GET",
                    dataType: "json",
